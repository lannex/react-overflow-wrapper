...
var OverflowList = function (_super) {
  ...
  function OverflowList() {
    ...
    _this.throttledResize = throttle_1.default(function () {
      _this.handleResize();
    }, 400);
    ...
    _this.handleWheel = function (e) {
      var _a = _this.state,
          isOverflow = _a.isOverflow,
          rootWidth = _a.rootWidth,
  ...
  OverflowList.prototype.componentWillUnmount = function () {
  ...
  OverflowList.prototype.render = function () {
    var _a = this.props,
        ...
        iconWrapStyle = _a.iconWrapStyle,
        iconStyle = _a.iconStyle,
        iconColor = _a.iconColor;
    var _b = this.state,
        x = _b.x,
        isOverflow = _b.isOverflow,
        isDragging = _b.isDragging,
        rootWidth = _b.rootWidth,
        wrapWidth = _b.wrapWidth;
    return react_1.default.createElement("div", {
      className: className,
      ref: this.rootRef,
      style: __assign({}, rootStyle, style)
    }, react_1.default.createElement("div", {
      ref: this.wrapRef,
      style: __assign({}, wrapStyle, {
        transition: isOverflow && isDragging ? 'none' : 'transform 0.3s ease-in-out',
    ...
    }, children), isOverflow && x < 0 && react_1.default.createElement("div", {
      style: __assign({}, arrowWrapStyle, {
        left: 0,
        textAlign: 'left'
      }, iconWrapStyle.left),
      role: "button",
      ...
      d: "M0-.25h48v48H0z",
      fill: "none"
    }))), isOverflow && -x < wrapWidth - rootWidth && react_1.default.createElement("div", {
      style: __assign({}, arrowWrapStyle, {
        right: 0,
        textAlign: 'right'
      }, iconWrapStyle.right),
